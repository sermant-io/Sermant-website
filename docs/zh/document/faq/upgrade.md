...
| Latest版本(2.3.0) | 类匹配 | 方法匹配 | 拦截器 |        拦截声明         | 字节码增强 |
| :---------------: | :----: | :------: | :----: | :---------------------: | :--------: |
|       2.2.2       |   ✅    |    ✅     |   ✅    | ✅ **部分 API 标注废弃** |     ✅      |
|       2.2.1       |   ✅    |    ✅     |   ✅    | ✅ **部分 API 标注废弃** |     ✅      |
|       2.2.0       |   ✅    |    ✅     |   ✅    | ✅ **部分 API 标注废弃** |     ✅      |
...
| LATEST版本（2.3.0） | 配置管理 | 服务管理 | 动态配置 | 心跳服务 | 日志 |
| :-----------------: | :------: | :------: | :------: | :------: | :--: |
|        2.2.2        |    ✅     |    ✅     |    ✅     |    ✅     |  ✅   |
|        2.2.1        |    ✅     |    ✅     |    ✅     |    ✅     |  ✅   |
|        2.2.0        |    ✅     |    ✅     |    ✅     |    ✅     |  ✅   |
...
2.2.x版本相对2.3.x版本使用方式无变化，无需做任何配置的修改。建议您使用最新版本的Sermant Agent以及Sermant Backend、Sermant Injector以获得更好的体验。
